...
var rootCmd = &cobra.Command{
	Use:   "calendar",
	Short: "Homework simple calendar service application",
	Long:  `Homework simple calendar service application: create, edit, delete events`,
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "logger", "", "logger file (default is $HOME/.calendar.yaml)")
}
