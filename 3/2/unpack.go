...
// Digit could be interpreted as a symbol. For this it should be escaped by symbol '\'. See examples below
// To represend symbol '\' use two slashes, like this "\\"
// Escaping before not digit symbol doesn't not effect (just skip slash in output)
//
//
...
func unpack(input string) (string, error) {
	...
	// is previous symbol is escape symbol '\'
	var isEscape = false
