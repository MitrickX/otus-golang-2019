...
type Event struct {
	id    int       // id of event, need for identify event in calendar
...
// Constructor for existing in calendar events
...
// Less method for compare 2 event, will need for sorting in calendar
